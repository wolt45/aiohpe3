AppPXPE.controller('PXListCtrl', function ($scope){
...
// AppPXPE.controller('PXListCtrl', function ($scope, $http){
...
AppPXPE.controller('PXDetailCtrl', function ($scope, $routeParams, $http){
  $scope.clinix = [];
...
// AppPXPE.controller('myBone', function ($scope) {
//   $scope.myBone = [
//   { 0 : "(undefined)"},
//   { 1 : "HIP"},
//   { 2 : "KNEE"},
