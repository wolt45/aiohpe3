IOHPEApp.controller('TreatmentCtrl', function ($scope, $routeParams, $http){
  ...
  $scope.addTreatment = function (grpTreatment) {
    ...
    grpTreatment.medAnalgesic = null;
    grpTreatment.medAntiInflamatory = null;
    grpTreatment.medOthers = null;

    grpTreatment.drugDozageAnalgesic = null;
    grpTreatment.drugDozageAntiInflame = null;
    grpTreatment.drugDozageOthers = null;

    grpTreatment.injSteroidsVolume = null;
    grpTreatment.injSteroidsWhen = null;
    grpTreatment.injSteroidsResult = null;
    grpTreatment.injSteroidsDetails = null;
    
    grpTreatment.injHyaluronicAcid = null;
    grpTreatment.injHyaluronicResult = null;
    grpTreatment.injHyaluronicDetails = null;
