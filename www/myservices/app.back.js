...
function PushController($rootScope, $scope, $http) {
	...
	$scope.Push_ClinixZZZZ = function(clinix){
		...
		$.ajax({
			type : "POST",
			url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_clinix.php',
			data : clinixJson,
			dataType : "json",
			restful : true,
  ...
  $scope.Push_Clinix = function() {
    ...
    promise.then(function(pxresult) {
      ...
      $http({
        method: 'POST'
        , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_clinix.php' //?clinixJsonIzed=' + $scope.clinix_JSON
        , contentType : 'application/json'
  ...
  $scope.Push_ZClinix = function() {
    ...
    promise.then(function(pxresult) {
      ...
      $http({
        method: 'POST'
        , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_Zclinix.php' //?clinixJsonIzed=' + $scope.clinix_JSON
        , contentType : 'application/json'
        , data : $scope.clinix_JSON
        , cache : false
      });
  ...
  $scope.PushIOH_ChiefComp = function() {
    ...
    promise.then(function(pxresult) {
        ...
        $http({
          method: 'POST'
          , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_IOH_ChiefComp.php' //?clinixJsonIzed=' + $scope.clinix_chiefcomp_JSON
          , contentType : 'application/json'
    ...
    promise.then(function(pxresult) {
      ...
      $scope.clinix_MedHist_JSON = JSON.stringify($scope.clinix_MedHist);
	    //$sJSONized = "[" + $scope.clinix_MedHist_JSON + "]";
      	$http({
      	  	method: 'POST'
      	  	, url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_IOH_MedHist.php' //?clinixJsonIzed=' + $scope.clinix_MedHist_JSON
      	  	, contentType : 'application/json'
	...
	$scope.PushIOH_LABS = function() {
      ...
      promise.then(function(pxresult) {
          ...
          $scope.clinix_LABS_JSON = JSON.stringify($scope.clinix_LABS);
        	...
        	$http({
        	  	method: 'POST'
        	  	, url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_IOH_Labs.php' //?clinixJsonIzed=' + $scope.clinix_LABS_JSON
        	  	, contentType : 'application/json'
	...
	$scope.PushIOH_PrevSurge = function() {
      ...
      promise.then(function(pxresult) {
          ...
          $scope.clinix_previousSurgeries_JSON = JSON.stringify($scope.clinix_previousSurgeries);
        	...
        	$http({
        	  	method: 'POST'
        	  	, url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_IOH_PrevSurgeries.php' //?clinixJsonIzed=' + $scope.clinix_previousSurgeries_JSON
        	  	, contentType : 'application/json'
	...
	$scope.PushIOH_PastTreatments = function() {
      ...
      promise.then(function(pxresult) {
          ...
          $scope.clinix_treatment_JSON = JSON.stringify($scope.clinix_treatment);
        	...
        	$http({
        	  	method: 'POST'
        	  	, url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_IOH_PastTreatment.php' //?clinixJsonIzed=' + $scope.clinix_treatment_JSON
        	  	, contentType : 'application/json'
  ...
  $scope.PushIOH_Ethiology = function() {
    ...
    promise.then(function(pxresult) {
        ...
        $scope.clinix_etiology_JSON = JSON.stringify($scope.clinix_etiology);
      	$http({
      	  	method: 'POST'
      	  	, url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_IOH_Ethiology.php' //?clinixJsonIzed=' + $scope.clinix_etiology_JSON
      	  	, contentType : 'application/json'
    ...
    promise.then(function(pxresult) {
        ...
        $scope.clinix_spineIntl_JSON = JSON.stringify($scope.clinix_spineIntl);
	     //$sJSONized = "[" + $scope.clinix_spineIntl_JSON + "]";
      	...
      	$http({
      	  	method: 'POST'
      	  	, url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_IOH_SpineIntl.php' //?clinixJsonIzed=' + $scope.clinix_spineIntl_JSON
      	  	, contentType : 'application/json'
  ...
  //Push HIP Measures
	$scope.pushHIPmeasurements = function(){
  	...
  	promise.then(function(pxresult) {
  	  	...
  	  	$http({
  	  	  	method: 'POST'
  	  	  	, url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_HIPmeasures.php' //?clinixJsonIzed=' + $scope.clinix_HipMeasures_JSON
  	  	  	, contentType : 'application/json'
  ...
  $scope.pushHIPstanding = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
          method: 'POST'
          , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_HIPstanding.php' //?clinixJsonIzed=' + $scope.clinix_HipStanding_JSON
          , contentType : 'application/json'
  ...
  $scope.pushHIPmotionRange = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
          method: 'POST'
          , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_HIPmotionrange.php' //?clinixJsonIzed=' + $scope.clinix_HipMotionRange_JSON
          , contentType : 'application/json'
  ...
  $scope.pushHIPxrays = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
          method: 'POST'
          , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_HIPxrays.php' //?clinixJsonIzed=' + $scope.clinix_HipXRays_JSON
          , contentType : 'application/json'
  ...
  $scope.pushKNEEmeasurements = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
          method: 'POST'
          , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_KNEEMeasures.php' //?clinixJsonIzed=' + $scope.clinix_KneeMeasures_JSON
          , contentType : 'application/json'
  ...
  $scope.pushKNEEappearance = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
          method: 'POST'
          , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_KNEEappearance.php' //?clinixJsonIzed=' + $scope.clinix_KneeAppearance_JSON
          , contentType : 'application/json'
  ...
  $scope.pushKNEEalignment = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
          method: 'POST'
          , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_KNEEalignment.php' //?clinixJsonIzed=' + $scope.clinix_KneeAlignment_JSON
          , contentType : 'application/json'
  ...
  $scope.pushKNEEmotionRange = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
          method: 'POST'
          , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_KNEEmotionrange.php' //?clinixJsonIzed=' + $scope.clinix_KneeMotionRange_JSON
          , contentType : 'application/json'
  ...
  $scope.pushKNEExrays = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
          method: 'POST'
          , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_KNEExrays.php' //?clinixJsonIzed=' + $scope.clinix_KneeXRays_JSON
          , contentType : 'application/json'
  ...
  $scope.Push_HIP_PREop_FORM = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
        method: 'POST'
        , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_PREop_HIP_Preform.php' //?clinixJsonIzed=' + $scope.clinix_PREOp_HIP_preform_JSON
        , contentType : 'application/json'
  ...
  $scope.Push_HIP_OP_Diagnosis = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
        method: 'POST'
        , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_OPHIP_1.php' //?clinixJsonIzed=' + $scope.jdata_OPHIP_1_JSON
        , contentType : 'application/json'
  ...
  $scope.Push_HIP_OP_Surgery = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
        method: 'POST'
        , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_OPHIP_2.php' //?clinixJsonIzed=' + $scope.jdata_OPHIP_2_JSON
        , contentType : 'application/json'
  ...
  $scope.Push_HIP_OP_Implant = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
        method: 'POST'
        , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_OPHIP_3.php' //?clinixJsonIzed=' + $scope.jdata_OPHIP_3_JSON
        , contentType : 'application/json'
  ...
  $scope.Push_HIP_OP_Acetabular = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
        method: 'POST'
        , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_OPHIP_4.php' //?clinixJsonIzed=' + $scope.jdata_OPHIP_4_JSON
        , contentType : 'application/json'
  ...
  $scope.Push_HIP_OP_Surgical = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
        method: 'POST'
        , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_OPHIP_5.php' //?clinixJsonIzed=' + $scope.jdata_OPHIP_5_JSON
        , contentType : 'application/json'
  ...
  $scope.Push_HIP_OP_Operative = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
        method: 'POST'
        , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_OPHIP_6.php' //?clinixJsonIzed=' + $scope.jdata_OPHIP_6_JSON
        , contentType : 'application/json'
  ...
  $scope.Push_HIP_POSTop_FORM = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
        method: 'POST'
        , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_POSTop_HIP_Preform.php'
        , contentType : 'application/json'
  ...
  $scope.Push_KNEE_PREop_FORM = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
        method: 'POST'
        , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_PREop_KNEE_Preform.php' //?clinixJsonIzed=' + $scope.clinix_PREOp_KNEE_preform_JSON
        , contentType : 'application/json'
  ...
  $scope.Push_KNEE_PREop_CONTACT = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
        method: 'POST'
        , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_PREop_KNEE_Contact.php' //?clinixJsonIzed=' + $scope.clinix_PREOp_KNEE_contact_JSON
        , contentType : 'application/json'
  ...
  $scope.Push_KNEE_PREop_ANTIBIOTICS = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
        method: 'POST'
        , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_PREop_KNEE_AntiBio.php' //?clinixJsonIzed=' + $scope.clinix_PREOp_KNEE_antibio_JSON
        , contentType : 'application/json'
  ...
  $scope.Push_KNEE_PREop_REPEAT = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
        method: 'POST'
        , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_PREop_KNEE_repeatB.php' //?clinixJsonIzed=' + $scope.clinix_PREOp_KNEE_repeatBilateral_JSON
        , contentType : 'application/json'
  ...
  $scope.Push_KNEE_OP_Diagnosis = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
        method: 'POST'
        , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_OPKNEE_1.php' //?clinixJsonIzed=' + $scope.jdata_OPKNEE_1_JSON
        , contentType : 'application/json'
  ...
  $scope.Push_KNEE_OP_Surgery = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
        method: 'POST'
        , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_OPKNEE_2.php' //?clinixJsonIzed=' + $scope.jdata_OPKNEE_2_JSON
        , contentType : 'application/json'
  ...
  $scope.Push_KNEE_OP_Implant = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
        method: 'POST'
        , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_OPKNEE_3.php' //?clinixJsonIzed=' + $scope.jdata_OPKNEE_3_JSON
        , contentType : 'application/json'
  ...
  $scope.Push_KNEE_OP_Surgical = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
        method: 'POST'
        , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_OPKNEE_4.php' //?clinixJsonIzed=' + $scope.jdata_OPKNEE_4_JSON
        , contentType : 'application/json'
  ...
  $scope.Push_KNEE_OP_Operative = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
        method: 'POST'
        , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_OPKNEE_5.php' //?clinixJsonIzed=' + $scope.jdata_OPKNEE_5_JSON
        , contentType : 'application/json'
  ...
  $scope.Push_KNEE_POSTop_FORM = function(){
    ...
    promise.then(function(pxresult) {
      ...
      $http({
        method: 'POST'
        , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_POSTop_KNEE_Preform.php'
        , contentType : 'application/json'
  ...
  $scope.pushSkelTrauma_1 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_SkelTrauma_1.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushSkelTrauma_2 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_SkelTrauma_2.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushGenOrtho_1 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_genotho_1.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushGenOrtho_2 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_genotho_2.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushGenOrtho_3 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_genotho_3.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushGenOrtho_4 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_genotho_4.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushGenOrtho_5 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_genotho_5.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushGenOrtho_6 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_genotho_6.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushSpine_1 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_spine_1.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushSpine_2 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_spine_2.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushSpine_3 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_spine_3.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushSpine_4 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_spine_4.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
...
$scope.pushSportsAnkleFoot = function(){
  ...
  //Push ALL pushSportsAnkleFoot_1
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_anklefoot_1.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  //Push ALL pushSportsAnkleFoot_2
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_anklefoot_2.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  //Push ALL pushSportsAnkleFoot_2
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_anklefoot_3.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  //Push ALL pushSportsAnkleFoot_2
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_anklefoot_4.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  //Push ALL pushSportsAnkleFoot_2
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_anklefoot_5.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  //Push ALL pushSportsAnkleFoot_2
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_anklefoot_6.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  //Push ALL pushSportsAnkleFoot_2
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_anklefoot_7.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
   ...
   $scope.pushSportsAnkleFoot_8 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_anklefoot_8.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushSportsAnkleFoot_9 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_anklefoot_9.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  //Push ALL pushSportsanklefoot_1
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_sportsknee_1.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_sportsknee_2.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushSportsKnee_3 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_sportsknee_3.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushSportsKnee_4 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_sportsknee_4.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushSportsKnee_5 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_sportsknee_5.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushSportsKnee_6 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_sportsknee_6.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
   ...
   $scope.pushSportsKnee_7 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_sportsknee_7.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushSportsKnee_8 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_sportsknee_8.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
 ...
 $scope.pushSportsSholder = function(){
  ...
  $scope.pushSportsSholder_1 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_sportsholder_1.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushSportsSholder_2 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_sportsholder_2.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushSportsSholder_3 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_sportsholder_3.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushSportsSholder_4 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_sportsholder_4.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushSportsSholder_5 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_sportsholder_5.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushSportsSholder_6 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_sportsholder_6.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushSportsSholder_7 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_sportsholder_7.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushSportsSholder_8 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_sportsholder_8.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
  ...
  $scope.pushSportsSholder_9 = function(){
    ...
    promise.then(function(pxresult) {
        ...
        $http({
            method: 'POST'
            , url : 'http://10.0.1.99/RBGsrvr_todayset/srvr_back_jdata_sportsholder_9.php' //?clinixJsonIzed=' + $scope.clinix_AmbuStatus_JSON
            , contentType : 'application/json'
