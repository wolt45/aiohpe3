$data.Entity.extend("$ipadrbg.types.jdata_Knee_4", {
	...
	, ExtensionCrepitation: { type: "string"}
	, ExtensionMMT: { type: "string"}
	, GaitNormalAbnormal: { type: "string"}
	, GaitType: { type: "string"}
