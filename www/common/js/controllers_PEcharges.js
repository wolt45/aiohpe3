...
IOHPEApp.controller('PEchargesCtrl', function ($scope, $routeParams, $http){
  ...
  $scope.notifyServer = function () {
    ...
    $http({
      method: 'POST'
      , url : 'http://127.0.0.1/RBGsrvr_todayset/srvr_back_clinixTrnStts.php' //?clinixJsonIzed=' + $scope.clinix_JSON
      , contentType : 'application/json'
    ...
    $http({
      method: 'POST'
      , url : 'http://127.0.0.1/RBGsrvr_todayset/srvr_back_PEcharges.php' //?clinixJsonIzed=' + $scope.clinix_PEcharges_JSON
      , contentType : 'application/json'
