IOHPEApp.controller('StrDiscdsig_Ctrl', function ($scope, $routeParams, $http){
  $scope.jdata_StrucDiscdsig = [];
  $scope.ClinixRID = $routeParams.p_clinixrid;


   $scope.StrDiscPinchecking = function(formPin) 
  {
    ...
    }else
    {
        ...
        promise.then(function(pxresult) {
          ...
          if(angular.isDefined(pxresult[0]['PIN']))
          {
              ...
              tx.executeSql("delete from 'jdata_StrucDiscdsig' WHERE ClinixRID = " + $scope.clinix.ClinixRID + " AND PxRID = " +$scope.clinix.PxRID);
              });
          }
          ...
          newrecord = {
            ...
            $ipadrbg.context.jdata_StrucDiscdsig.add(newrecord);
            $ipadrbg.context.jdata_StrucDiscdsig.saveChanges();
