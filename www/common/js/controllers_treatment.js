IOHPEApp.controller('TreatmentCtrl', function ($scope, $routeParams, $http){
  ...
  $scope.addTreatment = function (grpTreatment) {
    // if (grpTreatment.medAnalgesic == "none") {
    //   grpTreatment.medAnalgesic = "none";
    //   grpTreatment.medAntiInflamatory = "none";
    //   grpTreatment.injSteroidsVolume = "none";
    //   grpTreatment.injHyaluronicAcid = "none";
    // }
    ...
    if (
      ...
      alert ("Incomplete data, please go back!");
    }
  }
